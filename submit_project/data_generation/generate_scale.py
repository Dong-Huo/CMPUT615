...
class generate(object):
    ...
    def generate_single(self, folder_id, sub_dir):
        ...
        with open(self.target_directory + 'scale_' + folder_name + '/scale_' + folder_name + '.txt',
        ...
        with open(txt_file, 'r', encoding="UTF-8") as source:
            ...
            try:
                os.mkdir(self.target_directory + 'scale_' + folder_name + '/template_scale_' + folder_name)
            except:
                pass
            ...
            for i in range(len(lines[1:])):
                ...
                cv2.imwrite(self.target_directory + 'scale_' + folder_name + '/template_scale_' + folder_name + '/template' + str(
                    i + 1) + '.jpg',
                            template_window)
            ...
            try:
                os.mkdir(
                    self.target_directory + 'scale_' + folder_name + '/search_window_scale_' + folder_name)
            except:
                pass
            ...
            for i in range(1, len(lines)):
                ...
                cv2.imwrite(
                    self.target_directory + 'scale_' + folder_name + '/search_window_scale_' + folder_name + '/' + str(i) + '.jpg',
                    search_window)
...
gene = generate(224, './VOT16/', './scale_vot/')
gene.generate_all()
