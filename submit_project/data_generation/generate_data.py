...
class generate(object):
    ...
    def generate_single(self, folder_id, sub_dir):
        ...
        try:
            os.mkdir(self.target_directory + folder_name + '/')
        except:
            pass

        with open(self.target_directory + folder_name + '/' + folder_name + '.txt',
        ...
        with open(txt_file, 'r', encoding="UTF-8") as source:
            ...
            try:
                os.mkdir(self.target_directory + folder_name + '/template_' + folder_name)
            except:
                pass
            ...
            for i in range(len(lines[1:])):
                ...
                cv2.imwrite(self.target_directory + folder_name + '/template_' + folder_name + '/template' + str(
                    i + 1) + '.jpg',
                            template_window)
            ...
            try:
                os.mkdir(
                    self.target_directory + folder_name + '/search_window_' + folder_name)
            except:
                pass
            ...
            for i in range(1, len(lines)):
                ...
                cv2.imwrite(
                    self.target_directory + folder_name + '/search_window_' + folder_name + '/' + str(i) + '.jpg',
                    search_window)
...
gene = generate(224, './VOT16/', './org_vot/')
gene.generate_all()
