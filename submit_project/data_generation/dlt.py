...
class DLT(object):
    ...
    def get_template_window(self, src, ref_coor):
        M = self.DLT_transfer(ref_coor, [0, 0, 223, 0, 233, 233, 0, 223])
    ...
    def warp_next(self, W):
        ...
        a2 = np.float32(np.array([223, 0]))
        a3 = np.float32(np.array([223, 223]))
        a4 = np.float32(np.array([0, 223]))
